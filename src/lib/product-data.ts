...
export const productCatalog: Product[] = [
  ...
  { id: 334, name: 'Ritual Card - Blossom', configType: 'C', basePrice: 0, variants: ['Catalogue', 'Custom'], specialLogic: 'RitualCardBlossom', customFields: [{id: 'petals', name: 'Petals', type: 'numeric', rateKey: 'petal_rate', softConstraints: [{ type: 'min', value: 4, message: 'Min 4 petals.' }] }], addons: [{ id: 'physical', name: 'Physical', type: 'physical_quantity', rateKey: 'ritual_card_blossom_rate', softConstraints: [{ type: 'min', value: 25, message: 'MOQ is 25.' }] }] },
